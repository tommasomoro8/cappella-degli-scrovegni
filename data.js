const data = [
    ...
    },
    {
        ...
        subtitle: "Allegorie delle Virtù e dei Vizi",
        IT: {
            text: "Odio come motivo di acceso risentimento o come causa di discordia.<br>Si strappa le vesti, come il sommo sacerdote Caifa, in collera per le parole di Gesù, e come l’angioletto sotto il braccio sinistro di Gesù crocifisso, per l’incontentabile dolore. Guardate la smorfia della bocca, il naso troppo piccolo, e quegli occhi che sembrano due lame.",
            textAuthor: "Scritto da Ginevra Taddei",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Allegorie delle Virtù e dei Vizi",
        IT: {
            text: "Mutabilità di comportamento; mancanza di fermezza o di perseveranza.<br>In precario equilibrio su una ruota che corre verso il basso, sta cadendo all’indietro, come suggerisce anche il mantello svolazzante: appena viene indotta in tentazione, ci cade.",
            textAuthor: "Scritto da Ginevra Taddei",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "La Presentazione di Gesù al Tempio è un affresco di Giotto, risalente al 1305 circa e facente parte del ciclo della Cappella degli Scrovegni a Padova. <br>Il Tempio di Gerusalemme è richiamato dal ciborio con colonnine tortili ovvero che si avvolgono a spirale. Secondo la tradizione ebraica dopo la nascita di un figlio le donne dovevano presentarsi al tempio della città per fare dei bagni rituali di purificazione. In ambito cristiano la scena è vista come una sorta di rito di accettazione del bambino nella comunità, spesso associato al rito della circoncisione, che era accompagnato dall'offerta di due colombe, come infatti porta Giuseppe in mano. Gesù è affidato a Simeone, il sacerdote con l'aureola, figura di forte intensità espressiva. Una donna si trova vicino Giuseppe, semplice spettatrice, mentre dall'altro lato fa la sua comparsa la Profetessa Anna, con in mano un cartiglio, che è scossa dalla sua profezia che riconosce il Bambino nel “redentore di Gerusalemme”. Un angelo, impugnante un bastone dorato col trifoglio in cima, simbolo della Trinità, compare poi in cielo a testimoniare la soprannaturalità dell'evento.<br>Leggere sono le tonalità dei colori, che spiccano sull'azzurro del cielo (un po' danneggiato), in perfetta armonia con le altre scene della cappella.",
            textAuthor: "Scritto da Simone Brunello",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "La scena si svolge sotto un'impalcatura di legno su uno sfondo roccioso. Maria, con addosso una veste rosso intenso con bordature d'oro e un mantello blu, tiene il Figlio in fasce e coperto da una mantellina verde all'adorazione dei Re Magi, accorsi seguendo la Stella Cometa che si vede in alto. Ciascuno ha calzature rosse, simbolo di regalità. Il primo re, quello anziano, è già inginocchiato ed ha deposto la sua corona in terra, mentre il suo regalo è probabilmente l'oro, tenuto dall'angelo a destra. Il secondo re, di età matura, porta un corno pieno di incenso, mentre quello più giovane una coppa di cui solleva il coperchio per mostrare l'unguento di mirra. I tre doni simboleggiano rispettivamente la regalità del nascituro, la sua santità e il presagio della sua morte (la mirra si usava infatti per profumare i cadaveri). Dietro i Magi stanno due alti cammelli, bordati di finiture rosse, raffigurati con spiccato naturalismo e tenuti da due inservienti di cui solo quello in primo piano è visibile. Dietro Maria assiste Giuseppe e i due angeli, di cui uno, con estremo naturalismo, si trova in corrispondenza della trave della capanna ed ha quindi il viso coperto. Un muto dialogo si svolge tra i volti dei presenti, che intrecciano gli sguardi con grande naturalezza, evitando qualsiasi fissità di matrice bizantina. Alcuni dettagli sono legati alla quotidianità del Trecento, come la struttura “moderna” della capanna o la foggia degli abiti, come quello dell'angelo che ha la manica stretta ai polsi e larga ai gomiti. La cometa che si vede sul dipinto è forse stata ispirata dalla Cometa di Halley, di cui il pittore poteva essere stato testimone nel 1301.",
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "La “Natività di Gesù” di Giotto è un affresco appartenente al ciclo della Cappella degli Scrovegni a Padova, datato tra il 1303-1305; compreso nelle Storie di Gesù, ovvero una serie di episodi aventi Gesù come protagonista. Si colloca sulla parete destra, guardando verso l'altare, nel registro centrale superiore. Misura circa 203 centimetri in altezza e 200 in larghezza. La “Natività di Gesù” si può considerare una delle Natività più conosciute e popolari. <br>Come basi storiche storiche delle scene Giotto utilizzò più fonti, tra cui i Vangeli, il Protovangelo di Giacomo e anche la Leggenda Aurea di Jacopo da Varazze. <br>A fare da sfondo alla scena c’è un paesaggio roccioso in cui spicca un piccola struttura in legno dove si trovano Maria e Gesù. Maria è distesa ed ha appena partorito Gesù e lo sta mettendo dolcemente, già fasciato, nella mangiatoia. Maria viene aiutata da un inserviente, che tradizionalmente non è mai presente in questo episodio, davanti alla quale spuntano il bue e l'asinello. Giuseppe sta accovacciato, in basso a sinistra, dormiente; come tipico dell'iconografia, con una veste marrone chiaro. Giuseppe non è vicino alla moglie ma in una sezione a parte, questo sta a sottolineare la subordinazione rispetto al Padre Divino di Gesù. Il manto di Maria, un tempo azzurro lapislazzuli, è in parte logorato e ha lasciato scoperto il rosso della sottoveste. <br>A destra si svolge l'annuncio ai pastori. Due pastori vengono raffigurati di spalle di fianco al proprio gregge, mentre dall'alto un angelo li informa approposito l'evento miracoloso appena accaduto. Altri quattro angeli volano sopra la capanna, pregando e vegliando sul bambino nato.",
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "Cristo deriso è un affresco (200x185 cm) di Giotto, databile al 1303-1305 circa e situato nel registro centrale inferiore, nella parete destra guardando verso l'altare.<br>Dopo essere stato arrestato e giudicato, Gesù è incoronato di spine, deriso e flagellato dagli sgherri dei sommi sacerdoti. Nel dipinto si vede Cristo seduto a sinistra che sopporta, con sofferenza ma anche rassegnazione, le offese che gli vengono fatte, tirandogli i capelli e la barba, colpendolo con le mani e con bastoni, deridendolo. Nonostante questo, Cristo è raffigurato in tutta la sua regalità, coperto da un mantello ricamato d'oro.<br>La scena si svolge in un cortile entro il palazzo. Eleganti colonne sorreggono la trabeazione con una decorazione a palmette e a leoncini di gusto classicheggiante, secondo i modelli romani. Il volto di Pilato e quello a destra, forse di un soldato, sono dipinti con una volumetria e una resa naturalistica tanto forte da sembrare veri e propri ritratti. In questa scena la sperimentazione delle forme per masse colorate immerse nella luce raggiunge uno degli esiti più compiuti di tutto il ciclo pittorico.",
            textAuthor: "Scritto da Aurora Bozzo",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "Cristo davanti a Caifa è un affresco (200x185 cm) di Giotto, databile al 1303-1305 circa che fa parte del ciclo della Cappella degli Scrovegni a Padova. È compreso nelle Storie della Passione di Gesù del registro centrale inferiore, nella parete destra guardando verso l'altare.<br>La scena racconta che, dopo essere stato arrestato, Gesù viene portato dai sommi sacerdoti, Anna e poi Caifa, seduti in uno scranno, per essere interrogato. È accusato di blasfemia, un reato punibile con la morte.<br>Caifa si strappa la veste dal petto perché vorrebbe condannare Gesù a morte ma non può farlo poiché non ne ha l'autorità. Tra gli armigeri uno leva una mano per colpire Gesù, legato e strattonato al centro: proprio in casa di Caifa ebbe inizio la persecuzione di Cristo che nell'iconografia viene di solito indicata come la scena del Cristo deriso.<br>I volti sono arcigni e molto marcati. Il gesto di Caifa, caratterizzato da forte realismo, parla più delle parole, come pure il volto di Cristo, intenso nello sguardo, ma sofferente nel lieve inarcarsi delle spalle.<br><br>Originale è l'inventiva di Giotto rispetto all'iconografia tradizionale, che accentua la drammaticità degli avvenimenti, ma colpisce anche l'efficacia della costruzione prospettica dell'architettura, soprattutto nel soffitto.",
            textAuthor: "Scritto da Benedetta Martinelli",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "La Lavanda dei piedi è un affresco di Giotto, databile al 1303-1305 circa. Fa parte del ciclo della Cappella degli Scrovegni a Padova ed è compresa nelle Storie della Passione di Gesù del registro centrale inferiore, nella parete destra guardando verso l'altare.<br>Nella stessa stanza della scena precedente, l'Ultima Cena, Gesù si appresta a compiere un atto di umiltà lavando i piedi degli apostoli, iniziando da Pietro. Un altro apostolo si sta slacciando i sandali in primo piano a sinistra, mentre Giovanni sta in piedi dietro Gesù reggendo un contenitore con l'acqua. Le aureole risultano annerite, però non a causa del pittore in seguito di reazioni chimiche. Originariamente le aureole dei vari personaggi presentavano una differenziazione gerarchica: infatti quella di Cristo è a rilievo, dorata con oro fino e con la croce accennata in rosso; mentre sono di colore imitante l'oro e con raggi quelle degli apostoli. Giuda si intravede col mento appuntito, la barbetta tra gli apostoli seduti a sinistra e la sua aureola è priva di raggi.<br>Curatissimi sono i dettagli, dal manto con ricami dorati dell'apostolo al centro, ai mosaici che ornano il coronamento della stanza, sul cui tetto si possono notare due uccelli: sono statue in posizione identica, nella scena precedente dell'Ultima Cena. A differenza della scena precedente, qui si sono in parte conservati i decori a secco delle pareti. Le vesti degli apostoli creano un colorato insieme di tinte pastello, con un uso della luce che amplifica il senso di plasticità e aiuta a comprendere la scansione spaziale dell'ambiente.",
            textAuthor: "Scritto da Emma Vanin",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "l’Ultima cena è un’opera appartenente al ciclo degli affreschi della Cappella Degli Scrovegni a Padova, risale al 1303-1305 circa ed è compresa nella “storie di passione di Gesù” nel registro centrale inferiore del ciclo. La scena rappresenta un passo del vangelo di Giovanni molto famoso: “In verità, in verità vi dico: uno di voi mi tradirà” in cui i discepoli si guardano l’un l'altro, non sapendo di chi Gesù stia parlando; Si tratta del momento seguito dall'iconografia bizantina, mentre la tradizione romana preferiva rappresentare quello dello spezzare il pane da parte di Gesù. La scena è ambientata in una stanza priva di due pareti, in modo che le persone possano vedere al suo interno, e qui Giotto dipinge Cristo con i 12 apostoli che si guardano dubbiosi, e Giuda che intinge la mano nello stesso piatto di Gesù, mentre Giovanni si addormenta appoggiato a Cristo. Le aureole sono non più bianche, bensì nere, ma questo cambiamento non è volontario, ma causato da delle reazioni chimiche avvenute con il tempo; queste aureole in realtà presentavano un sistema gerarchico: quella di Gesù Cristo dorata con oro fino e con la croce accennata in rosso, quella degli apostoli era di un colore simile all’oro e con dei raggi, mentre quella di Giuda era senza raggi, per rappresentare appunto il colpevole; infine per gli apostoli di spalle sembra quasi che l’aureola stia fluttuando davanti ai loro volti. La parete interna era un tempo decorata da motivi a secco, che però oggi sono perduti; i vestiti degli apostoli sono di tinta pastello, con l’utilizzo della luce che amplifica il senso di plasticità e aiuta a comprendere lo spazio. Infine i dettagli sono molto curati, si guarda ad esempio il manto con ricami dorati dell’apostolo al centro di spalle, oppure i mosaici; inoltre sul tetto vi sono due uccelli che stanno ad indicare la scena seguente: la Lavanda dei piedi.",
            textAuthor: "Scritto da Alberto Baldasso",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "Storie della Vergine",
        IT: {
            text: "L’angelo nunziante fa parte del doppio affresco di Giotto databile tra il 1303 e il 1305, chiamato l’Annunciazione e situato sull’arco di trionfo presso l’altare al di sotto della lunetta. In questo doppio dipinto, diviso in due finte architetture speculari, si vede realizzato quanto deciso da Dio al di sopra della lunetta.<br>L’affresco dell’Annunciazione presenta due stanze con balconcini aggettanti nella parte superiore, e presenta inoltre un’attenta cura dei dettagli quali i cassettoni, le cornici colorate, le mensole ornate.<br>L’angelo, che si trova nella parte sinistra dell’affresco, è inginocchiato e sembra che nonostante la distanza fisica che li separa, quest’ultimo e Maria, situata nella parte destra, si stiano scambiando un intenso sguardo. Lo sfondo scuro è illuminato dalla luce rossa dell’amore divino, che impone immediatamente l’Annunciazione agli spettatori che entrano nella cappella.<br>L’Angelo è rappresentato compiere gesti lenti e calibrati, di una lentezza quasi solenne, rappresentati dal suo braccio destro leggermente alzato. L’aureola, come quella di Maria nella parte destra dell’affresco, viene rappresentata da Giotto come un dischetto dorato posto sul retro del capo del personaggio, in rappresentanza della sua piena padronanza del profilo, recuperata dall’arte antica.",
    ...
    },
    {
        ...
        subtitle: "Coretti",
        IT: {
            text: "Giotto decise di dipingere due ambienti voltati a crociera ed in prospettiva, posti ai lati dell’arco trionfale, sulla parete orientale della cappella, subito sopra lo zoccolo perimetrale, essi vengono comunemente chiamati corretti.<br>Questi due ambienti sono delle immagini illusionistiche che ingannano l’occhio e creano degli ambienti virtuali che in realtà non esistono ma nello specifico simulano la presenza del transetto.<br>L’immagine presenta appunto due voltati a crociera raffigurati in prospettiva dove al centro delle volte pendono delle lampade.<br>I due corretti rappresentano alla perfezione la prospettiva medievale.",
            textAuthor: "Scritto da Leonardo Bardi",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "La volta",
        IT: {
            text: "Questo particolare costituisce la parte centrale dell’affresco del giudizio universale, sempre realizzato da Giotto tra il 1303 ed il 1305.<br>Ritrae Cristo Giudice che campeggia al centro, circondato da una mandorla iridata.<br>Egli sta esponendo le piaghe della Passione, con l’esplicito gesto delle mani, più precisamente sta generando l'inferno con la sinistra dell'aura e rivolge lo sguardo e la mano destra agli eletti.<br>Non è seduto su un trono ma su una sorta di nube, sotto la quale si trovano alcune rappresentazioni simboliche, già interpretate come i simboli degli evangelisti. <br>Da uno studio più recente è stato invece riconosciuto qualcosa di più complesso: si vedono un angelo, un uomo con testa da leone, un centauro, simbolo della doppia natura di Cristo, umana e divina, e un orso con un pesce, simbolo della pesca delle anime oppure, del sacrificio di Cristo per redimere la bestialità della razza umana.. <br>Gesù rappresenta il fulcro dell'intera scena, che genera l'inferno con la sinistra dell'aura e rivolge lo sguardo e la mano destra agli eletti, in processione alla sua destra. Verso di lui tendono a orientarsi tutti i nuclei delle figure. Tutto di lui è aperto verso gli eletti, alla sua destra: lo sguardo, la piaga, il costato, mentre la sinistra è chiusa sui reprobi dell'inferno. Intorno alla mandorla stanno i serafini. In trono disposti a semicerchio, intorno a Gesù, ci sono i dodici apostoli.",
            textAuthor: "Scritto da Greta Beraldo",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
    ...
    },
    {
        ...
        subtitle: "La volta",
        IT: {
            text: "L’affresco è situato sulla volta a botte e misura circa un metro di diametro. e’ datato circa tra il 1303 e il 1305, dipinto da Giotto. Raffigura la Madonna che tiene in braccio Gesù Bambino. E’ dipinto entro un cerchio, contornato da oro e decorazioni varie, inserito nel cielo stellato. La Madonna indossa una veste blu lapislazzuli con rifinimenti in ora, e una specie di tunica bianca, ha un velo di colore originario rosso, oggi andato in parte perso, e ha un’aureola d’oro. Gesù Bambino indossa solo una veste bianca contornata d’oro e, come Maria, ha l’aureola d’oro. Maria ha i tratti somatici tipici e tradizionali: occhi grandi, naso abbastanza stretto e allungato e bocca piccola.",
            textAuthor: "Scritto da Francesca Frassetto",
            audioAuthor: "Voce di Ginevra Taddei"
        },
        EN: {
