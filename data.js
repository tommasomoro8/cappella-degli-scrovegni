...
const data = [
    ...
    },
    {
        ...
        subtitle: "Storie di Gesù",
        IT: {
            text: "Le Nozze di Cana è un affresco di Giotto (200x185 cm), databile al 1303-1305 circa. È compreso nelle Storie di Gesù del registro centrale superiore, nella parete sinistra guardando verso l'altare.<br>Protagonisti dell’opera sono Gesù e Maria, posti uno a sinistra della rappresentazione e l’altra a destra; sono, insieme a S. Pietro, gli unici personaggi ritratti con l’aureola. Sulla destra l’attenzione è decisamente catturata dal grasso maestro, intento ad assaggiare il vino nuovo. Proprio questo personaggio testimonia il fatto che Giotto rinnova il modo di ritrarre le figure umane proponendo, spesso, vere e proprie istantanee della vita del suo tempo.<br>Il lato del tavolo rivolto allo spettatore ha al centro la sposa, vestita con un abito rosso ricamato con finezza, seduta accanto alla Madonna, anch'essa benedicente, e a una ragazza con una corona di fiori in testa. Due inservienti stanno dall'altra parte del tavolo.<br>Seguendo il Vangelo di Giovanni è mostrato il momento in cui Gesù, seduto a sinistra accanto allo sposo e vicino a un apostolo, benedice con un gesto l’acqua versata nelle grandi giare dall’altra parte della stanza e trasformandola in vino.<br>La scena è ambientata in una stanza aperta verso il cielo: drappi rossi rigati coprono le pareti, un fregio corre in alto e in alto stanno grate lignee traforate e rette da mensole, sulle quali si trovano dei vasi e degli elementi decorativi.<br>Le tonalità di color pastello accentuano col chiaroscuro i volumi plastici delle figure. Notevole cura è riposta nella descrizione degli oggetti, dalla tovaglia candida che crea fasce di diverso colore, alle giare finemente scanalate, fino alle pietanze sulla tavola. Il maestro di mensa e il ragazzo dietro di lui sono così ben caratterizzati da aver fatto ipotizzare che si tratti di ritratti di personaggi realmente esistiti.",
